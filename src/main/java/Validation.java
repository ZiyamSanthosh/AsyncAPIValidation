...
public class Validation{
    ...
    public static void main(String[] args) throws IOException {
        ...
        Schema schemaValidator = SchemaLoader.load(new JSONObject(SCHEMA));
        ...
        try {
            ...
            //schemaValidator.validate(validation.convertURLtoJSON("https://raw.githubusercontent.com/asyncapi/asyncapi/master/examples/2.0.0/streetlights.yml"));

            //validation.validateURL("https://raw.githubusercontent.com/asyncapi/asyncapi/master/examples/2.0.0/streetlights.yml");

            System.out.println("Validation successful!");

            //retrieve data of the API
            //validation.getDataOfAPI(validation.convertYamlFileToJSONObject("websocket.yml"));
            //validation.getDataOfAPI(validation.importSampleSchema("streetlights.json"));
            //validation.getDataOfAPI(validation.convertURLtoJSON("https://raw.githubusercontent.com/asyncapi/asyncapi/master/examples/2.0.0/streetlights.yml"));
            ...
            if (e.getAllMessages().contains("#: required key [asyncapi] not found")){
                System.out.println("mention asyncapi key");
            }
        }
    ...
    public JSONObject convertURLtoJSON(String fileURL) throws IOException {
        URL url = new URL(fileURL);
        ObjectMapper yamlReader = new ObjectMapper(new YAMLFactory());
        Object obj = yamlReader.readValue(url, Object.class);
        ObjectMapper jsonWriter = new ObjectMapper();
        String json = jsonWriter.writeValueAsString(obj);
        return new JSONObject(json);
    }

    public void validateURL(String fileURL) throws IOException {
        URL url = new URL(fileURL);
    ...
    public void getDataOfAPI(JSONObject api){
        ...
        //
        System.out.println(api.getJSONObject("servers").names());
        for (Iterator<String> it = api.getJSONObject("servers").keys(); it.hasNext(); ) {
            String server = it.next();
            System.out.println(server);
            System.out.println(api.getJSONObject("servers").getJSONObject(server).getString("url"));
        }
